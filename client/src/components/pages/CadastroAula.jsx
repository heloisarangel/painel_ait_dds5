...
function CadastroAula() {
    ...
    const [unidadeCurrricular,setUnidadeCurricular] = useState('');
        ...
        <div>
            ...
            <div className='container col-sm-12  col-md-6 col-lg-3 mt-3'>
                ...
                <form onSubmit={cadastrarAula}>
                    ...
                    <input className='form-control' type="text" name="" id="" value={unidadeCurrricular} onChange={(e) => (setUnidadeCurricular(e.target.value))}/>
